...
;(function () {
  ...
  `
    ...
    function injectPopoutButton(el) {
        const poppedoutWindowMsg = '(Window is popped out)';
      const buttons = el.lastChild.firstChild
      const refButton = buttons.firstChild.firstChild
      const b = document.createElement('div')
      b.classList = '__gmgv-popout'
      ...
      b.innerHTML = `
        <div class="${refButton.classList}">
          <span class="${refButton.children[1].classList}">
            ...
            <g id="surface1">
            <path style=" stroke:none;fill-rule:nonzero;fill:#fff;fill-opacity:1;" d="M 7.011719 0.308594 C 6.492188 0.445312 6.03125 0.839844 5.816406 1.328125 C 5.730469 1.507812 5.714844 1.773438 5.691406 3.601562 L 5.667969 5.667969 L 3.597656 5.695312 C 1.632812 5.71875 1.523438 5.726562 1.292969 5.832031 C 0.914062 6.011719 0.625 6.296875 0.433594 6.691406 L 0.261719 7.046875 L 0.246094 14.597656 C 0.234375 22.140625 0.234375 22.152344 0.34375 22.515625 C 0.441406 22.835938 0.503906 22.929688 0.785156 23.214844 C 1.070312 23.496094 1.167969 23.5625 1.484375 23.65625 C 1.851562 23.765625 1.859375 23.765625 9.402344 23.757812 L 16.957031 23.742188 L 17.3125 23.566406 C 17.703125 23.375 17.988281 23.089844 18.167969 22.707031 C 18.277344 22.480469 18.28125 22.367188 18.308594 20.402344 L 18.332031 18.335938 L 20.402344 18.308594 C 22.367188 18.28125 22.476562 18.277344 22.707031 18.171875 C 23.085938 17.988281 23.375 17.703125 23.566406 17.3125 L 23.738281 16.957031 L 23.753906 9.402344 C 23.765625 1.863281 23.765625 1.851562 23.65625 1.484375 C 23.558594 1.167969 23.496094 1.074219 23.214844 0.785156 C 22.933594 0.511719 22.828125 0.441406 22.527344 0.347656 C 22.164062 0.234375 22.140625 0.234375 14.707031 0.242188 C 8.980469 0.242188 7.199219 0.257812 7.011719 0.308594 Z M 21.964844 9.273438 L 21.964844 16.507812 L 7.496094 16.507812 L 7.496094 2.039062 L 21.964844 2.039062 Z M 5.691406 12.222656 L 5.691406 16.957031 L 5.847656 17.273438 C 6.027344 17.652344 6.308594 17.949219 6.671875 18.140625 L 6.9375 18.28125 L 11.71875 18.296875 L 16.503906 18.308594 L 16.503906 21.964844 L 2.035156 21.964844 L 2.035156 7.496094 L 5.691406 7.496094 Z M 5.691406 12.222656 "/>
            <path style=" stroke:none;fill-rule:nonzero;fill:#fff;fill-opacity:1;" d="M 13.511719 3.917969 C 12.789062 4.179688 12.710938 5.164062 13.378906 5.554688 C 13.554688 5.664062 13.660156 5.667969 15.28125 5.683594 L 16.996094 5.699219 L 14.128906 8.570312 C 12.152344 10.554688 11.238281 11.507812 11.179688 11.640625 C 11.066406 11.917969 11.078125 12.160156 11.222656 12.425781 C 11.4375 12.832031 11.921875 13.003906 12.359375 12.824219 C 12.492188 12.765625 13.445312 11.847656 15.429688 9.871094 L 18.300781 7.003906 L 18.316406 8.71875 C 18.332031 10.34375 18.339844 10.449219 18.445312 10.625 C 18.570312 10.847656 18.835938 11.03125 19.085938 11.078125 C 19.511719 11.160156 19.992188 10.84375 20.109375 10.421875 C 20.144531 10.261719 20.164062 9.347656 20.152344 7.347656 L 20.136719 4.5 L 20.015625 4.304688 C 19.945312 4.199219 19.800781 4.054688 19.695312 3.988281 L 19.5 3.867188 L 16.609375 3.855469 C 14.214844 3.84375 13.683594 3.855469 13.511719 3.917969 Z M 13.511719 3.917969 "/>
            </g>
          </span>
          <div>Popout Video</div>
        </div>
      `
      b.onmousedown = e => e.stopPropagation()
      b.onclick = e => {
        e.preventDefault()
        const elm = e.target.closest('[data-initial-participant-id]');
        const videoEl = elm.querySelector('video');
        if (videoEl && videoEl.oldSrcObject) {
            videoEl.srcObject = videoEl.oldSrcObject;

            delete window.popuedOutWindow;
            delete videoEl.oldSrcObject;

            if (widow.popuedOutWindow) {
                window.popuedOutWindow.close();
            }
        ...
        if (videoEl && videoEl.srcObject) {
            ...
            elm.querySelector('[data-self-name]').innerHTML = elm.querySelector('[data-self-name]').innerHTML + poppedoutWindowMsg;
            window.popuedOutWindow = window.open("", "Google Meet Popout", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes");
            window.popuedOutWindow.document.body.innerHTML = `
                <div style="
                position: relative;
                width: 100vw;
                height: 100vh;
            ">
              <video controls autoplay id="my-video" style="
                width: 100%;
                height: 100%;
                object-fit: contain;
                // pointer-events: none;
            ...
            ">
                ...
                padding: 5px 10px;
                border-radius: 5px;
            ">Marudhu Pandiyan G</div>
                <!-- <button type="button" id="play" style="
                border: none;
                position: absolute;
                right: 16px;
                top: 0;
            ...
            window.popuedOutWindow.onunload = function() {
                videoEl.srcObject = videoEl.oldSrcObject;
                delete window.popuedOutWindow;
                delete videoEl.oldSrcObject;
            ...
            const childVideo = window.popuedOutWindow.document.getElementById('my-video');
            childVideo.srcObject = videoEl.srcObject;
            videoEl.oldSrcObject = videoEl.srcObject;
      ...
      b._refresh = () => {
        const elm = b.closest('[data-initial-participant-id]');
        const videoEl = elm.querySelector('video');
        if (videoEl && videoEl.srcObject) {
            delete b.style.display;
        } else {
